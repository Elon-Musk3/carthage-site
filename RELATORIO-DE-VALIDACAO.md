...
Validação executada em 28 de julho de 2026 sobre a versão 18 desta pasta.
...
- **Proteção contra clique atravessado:** o painel permanece aberto durante o `pointerdown`; o clique externo é cancelado e interrompido antes de fechar o menu, inclusive quando o alvo subjacente é um link ou CTA, sem executar a ação escondida nem perder a posição de leitura.
